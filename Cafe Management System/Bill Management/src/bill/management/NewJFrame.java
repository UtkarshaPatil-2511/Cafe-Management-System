  ...
  public void addtable(int id ,String Name, int Qty ,Double Price){
   ...
   double tot = 0.0 ;
    ...
    private void initComponents() {
        ...
        jButton9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/10.png"))); // NOI18N
...
//        jButton11.setBackground(Color.red);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        addtables(8, "FrenchFries ", i, 80.00);
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        try {
           ...
           b.setText("                         Patel chowk \n");
            b.setText(b.getText() + "                         Sangli Miraj Road, \n");
            b.setText(b.getText() + "                         Sangli, India, \n");
            b.setText(b.getText() + "                         +91 9873456298, \n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            ...
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            b.setText(b.getText() + "       +8              Thanks For Your Business...!"+"\n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            b.setText(b.getText() + "                     Software by Utkarsha and Mayuri"+"\n");
